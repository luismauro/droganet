<%-- 
    ...
    Created on : 11/11/2016, 21:30:24
    Author     : luis
--%>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5"> 
                                <select class = "largura_campo">
                                    <option value="x">Nome Funcionário</option>
                                    <option value="x">xxxxx</option>
                                </select>
                            </div>							
                        </div>					
                        <div class="form-group">
                            <label class="col-sm-1">Data:  </label>
                            <div class="col-sm-5"> 
                                <input class="form-control" type="date" name="data" min="2016-01-01" max="2017-12-30">
                            </div>
                            <label class="col-sm-1">Loja:</label>
                            <div class="col-sm-5"> 
                                <select class = "largura_campo">
                                    <option value="x">Nome Loja</option>
                                    <option value="x">xxxxx</option>
                                </select>
                            </div>						
                        </div>
