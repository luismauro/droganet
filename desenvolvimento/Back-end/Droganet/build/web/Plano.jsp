<%-- 
    Document   : plano
    Created on : Nov 3, 2016, 10:51:03 PM
        ...
        <div class="col-md-3">
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <a href="#"><i class="fa fa-twitter-square fa-3x color-twitter32"></i></a>
                    ...
                    <div id="pricing-table" class="row">
                        <div class="col-md-4 col-sm-4">
                            <ul class="plan-main">
                                ...
                                <li class="plan-price">R$ 1.000</li>
                                <li>Cadastro 03 Lojas</li>
                                <li>Controle de Estoque</li>
                                <li>Cadastro de Funcionarios</li>
                                <li>Geração de Relatórios</li>
                                <li>Direito de Suporte</li>
                                <li class="plan-action"><a href="CadastrarRede.jsp?id=1" class="btn2 btn-default ">Assinar Agora</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-sm-4">
                             <ul class="plan-main">
                                <li class="plan-name">Medium</li>
                                <li class="plan-price">R$ 1.500</li>
                                <li>Cadastro 05 Lojas</li>
                                <li>Controle de Estoque</li>
                                <li>Cadastro de Funcionarios</li>
                                <li>Geração de Relatórios</li>
                                <li>Direito de Suporte</li>
                                <li class="plan-action"><a href="CadastrarRede.jsp?id=2" class="btn2 btn-default ">Assinar Agora</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-sm-4">
                             <ul class="plan-main">
                                <li class="plan-name">Advance</li>
                                <li class="plan-price">R$ 3.000</li>
                                <li>Cadastro 10 Lojas</li>
                                <li>Controle de Estoque</li>
                                <li>Cadastro de Funcionarios</li>
                                <li>Geração de Relatórios</li>
                                <li>Direito de Suporte</li>
                                <li class="plan-action"><a href="CadastrarRede.jsp?id=3" class="btn2 btn-default">Assinar Agora</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
