<%-- 
    Document   : CaixaFinal
    Created on : 11/11/2016, 21:13:02
    Author     : luis
--%>
        ...
        <div class="container">
            <div class="row main-low-margin ">
                ...
                <form class="form-horizontal col-sm-12" align="center">             
                    <fieldset>
                        <legend><h1>Caixa Final</h1></legend>     
                        <table class="col-sm-12" align="center">
                            ...
                            <tr>
                                ...
                                <td></td>                           
                                <td>
                                    <button type="submit" class="btn btn-danger glyphicon glyphicon-remove" title="Excluir"/> 
                                    <button type="submit" class="btn btn-primary glyphicon glyphicon-barcode" title="Faturar" />
                                </td>
                            </tr>
                        </table>    
                    </fieldset>
