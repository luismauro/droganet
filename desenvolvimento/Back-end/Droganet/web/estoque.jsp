<%-- 
    Document   : estoque
    Created on : 11/11/2016, 20:14:33
    Author     : luis
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="row main-low-margin ">
                ...
                <fieldset>
                <legend><h1>Estoque</h1></legend>
                    
                    <div class="form-group">
                        <label class="col-sm-1">Nome:</label>
                        <div class="col-sm-9"> 
                            <input type="text" class="form-control" id="loja" placeholder="Digite o nome do produto">
                        </div>                       
                    </div>
					<div class="form-group">						
                        <label class="col-sm-1">Qtde:</label>
                        <div class="col-sm-5"> 
                            <input type="text" class="form-control" id="loja" placeholder="Digite a quantidade do produto">
                        </div> 					
                    ...
                    <div class="form-group"> 
                        <div>
							...
							<div class="col-sm-5"> 
								<input type="text" class="form-control" id="loja" placeholder="Digite a unidade">
							</div> 
                        </div>                 
