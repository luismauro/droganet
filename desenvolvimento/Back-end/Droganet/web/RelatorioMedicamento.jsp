<%-- 
    Document   : RelatorioMedicamento
    Created on : 11/11/2016, 21:26:13
    Author     : luis
--%>
    ...
    <body>
		...
		<div class="container">
			<div class="row main-low-margin ">
				...
				<fieldset>
				<legend><h1>Medicamentos</h1></legend>
					
					<div class="form-group">
					    <label class="col-sm-1">Nome:</label>
						<div class="col-sm-7"> 
							<input type="text" class="form-control" id="nome" placeholder="Digite o nome do medicamento">	
						</div>
					</div>
					<div class="form-group">
					    <label class="col-sm-1">Tipo:</label>
						<div class="col-sm-3"> 
							<select class = "largura_campo">
								<option value="x">Tipo Remédio</option>
								<option value="x">xxxxx</option>
							</select>
						</div>
					    <label class="col-sm-1">Fornecedor:</label>
						<div class="col-sm-5"> 
							<select class = "largura_campo">
								<option value="x">Fornecedor 1</option>
								<option value="x">xxxxx</option>
							</select>
						</div>						
					</div>					
					<div class="form-group">
						<div align = "right">
							<div class="col-sm-8"> 
								...
								<button type="submit" class="btn btn-primary glyphicon glyphicon-search"> Imprimir</button>
							</div>
						</div>												
					</div>
					</br>
					<table class = "tb_resultado1">
						<tr>
							<th>Nome</th>
							<th>Tipo</th>
							<th>Fornecedor</th>
