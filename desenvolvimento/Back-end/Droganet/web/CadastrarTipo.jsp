<%-- 
    Document   : CadastrarTipo
    Created on : 11/11/2016, 21:10:24
    Author     : luis
--%>
	...
	<div class="col-md-6">
        ...
        <div class="container">
            <div class="row main-low-margin ">
                ...
                <fieldset>
                <legend><h1> Novo Tipo</h1></legend>
                    
                    <div class="form-group">
                        <label class="col-sm-1">Título:</label>
                        <div class="col-sm-9"> 
                            <input type="text" class="form-control" id="" placeholder="Digite o Título">
                        </div>                            
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1">Descrição:</label>
                        <div class="col-sm-9"> 
                            <input type="text" class="form-control" id="" placeholder="Digite a Descrição">
                        </div>                            
                    </div>
