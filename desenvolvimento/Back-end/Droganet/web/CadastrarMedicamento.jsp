<%-- 
    Document   : CadastrarMedicamento
    Created on : 11/11/2016, 21:00:29
    Author     : luis
--%>
        ...
        <div class="container">
            <div class="row main-low-margin ">
                ...
                <form class="form-horizontal col-sm-12" align="center">             
                    <fieldset>
                        <legend><h1> Novo Remédio</h1></legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="sexo" class = "largura_campo">
                        ...
                        <div>
                            <div class="form-group">
                                <label class="col-sm-1">Estoque Max:</label>
                                <div class="col-sm-5"> 
                                    <input type="text" class="form-control" id="cpf" placeholder="Estoque">                            
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-1">Estoque Min:</label>
                                <div class="col-sm-5"> 
                                    <input type="text" class="form-control" id="rg" placeholder="Estoque Mínimo">
                                </div>  
                                <label class="col-sm-1">Unidade:</label>
                                <div class="col-sm-5">
                                    <select name="sexo" class = "largura_campo">
                                        <option value="">tipo 1</option>
                                        <option value="">tipo 2</option>                             
