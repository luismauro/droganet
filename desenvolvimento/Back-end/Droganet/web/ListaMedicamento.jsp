<%-- 
    Document   : ListaMedicamento
    Created on : 11/11/2016, 21:21:49
    Author     : luis
--%>
                ...
                <form class="form-horizontal col-sm-12" align="center">				
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-1">Medic..:</label>
                            <div class="col-sm-9"> 
                                <input type="text" class="form-control" id="loja" placeholder="Digite o nome do medicamento">
                            </div>
                        </div>
                        <div class="form-group">
                            <div align = "right">
