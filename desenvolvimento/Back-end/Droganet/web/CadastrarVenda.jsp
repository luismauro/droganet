<%-- 
    Document   : venda
    Created on : 11/11/2016, 20:22:23
    Author     : luis
--%>
       ...
       <div class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="container">
            <div class="row main-low-margin ">
                ...
                <fieldset>
                <legend><h1> Nova Venda</h1></legend>
                    
                    <div class="form-group">
                        <label class="col-sm-1">Vendedor:</label>
                        <div class="col-sm-5"> 
                            <input type="text" class="form-control" id="nome" placeholder="Digite o nome do vendedor">
                        </div>        
                        <label class="col-sm-1">Código:</label>
						<div class="col-sm-3"> 
                                <select name="" class = "largura_campo">
					...
					<table class = "tb_resultado">
						<tr>
							<td><strong>Ultimas Vendas</strong></td>
						</tr>
					</table>
                    </br>                     
                    <div class="form-group">
                        ...
                        <div class="col-sm-5"> 
                            <input type="text" class="form-control" id="" placeholder="valor da compra">
                        </div>
                        <label class="col-sm-1">Crédito:</label>  
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="" placeholder="Qtd créditos do cliente"> 
                        </div>                      
                    </div>
                    <div class="form-group">                        
                        <label class="col-sm-1">Quantidade:</label>
							<div class="col-sm-5"> 
                                <input type="text" class="form-control col-sm-2" id="" placeholder="">
